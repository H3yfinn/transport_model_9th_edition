...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\experimental\\' + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
...
if change_dataframe_aggregation is not None:
    ...
    #fig.write_image(config.root_dir + config.slash + "\\plotting_output\\static\\" + title + '.png', scale=1, width=2000, height=1500)
...
for transport_type in model_output_detailed_medium_road['Transport Type'].unique():
    ...
    for vehicle in model_output_detailed_ttype['Vehicle Type'].unique():
        ...
        plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\for_others\\' + title + '_' + vehicle + '_' + transport_type + '.html',auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
        #fig.write_image(config.root_dir + config.slash + "\\plotting_output\\static\\" + title + '_' + vehicle + '_' + transport_type + '.png', scale=1, width=2000, height=1500)
...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\input_exploration\\' + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
#fig.write_image(config.root_dir + config.slash + "\\plotting_output\\input_exploration\\static\\" + title + '.png', scale=1, width=2000, height=800)
...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\input_exploration\\' + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
#fig.write_image(config.root_dir + config.slash + "\\plotting_output\\input_exploration\\static\\" + title + '.png', scale=1, width=2000, height=1500)
#%%
...
plt.title(title)
plt.savefig(config.root_dir + config.slash + 'plotting_output\\diagnostics\\{}.png'.format(title))
