...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\plot_input_data\\' + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
fig.write_image(config.root_dir + config.slash + "\\plotting_output\\plot_input_data\\static\\" + title + '.png', scale=1, width=2000, height=800)
...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\plot_input_data\\' + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
fig.write_image(config.root_dir + config.slash + "\\plotting_output\\plot_input_data\\static\\" + title + '.png', scale=1, width=2000, height=1500)
#%%
