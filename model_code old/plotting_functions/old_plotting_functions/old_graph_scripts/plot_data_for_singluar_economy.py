...
#load data in
model_output_all = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output\\{}'.format(config.model_output_file_name))
...
model_output_with_fuels = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\{}'.format(config.model_output_file_name))
model_output_8th = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\activity_energy_road_stocks.csv')
#%%
...
if not os.path.exists(config.root_dir + config.slash + 'plotting_output\\{}'.format(economy)):
...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\{}\\'.format(economy) + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
fig.write_image(config.root_dir + config.slash + "\\plotting_output\\{}\\static\\".format(economy) + title + '.png', scale=1, width=2000, height=800)
...
# fig.write_image(config.root_dir + config.slash + "\\plotting_output\\static\\" + title + '.png', scale=1, width=2000, height=800)
...
model_output_all = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output\\{}'.format(config.model_output_file_name))
model_output_detailed = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\{}'.format(config.model_output_file_name))
# change_dataframe_aggregation = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\road_model\\change_dataframe_aggregation.csv')
model_output_with_fuels = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\{}'.format(config.model_output_file_name))
model_output_8th = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\activity_energy_road_stocks.csv')
#%%
#economys:'01_AUS', '02_BD', '03_CDA', '04_CHL', '05_PRC', '06_HKC',
...
#     if not os.path.exists(config.root_dir + config.slash + f'plotting_output\\{save_folder}'):
#         os.makedirs(f'\\plotting_output\\{save_folder}')
#     #create static folder too
#     if not os.path.exists(config.root_dir + config.slash + f'plotting_output\\{save_folder}\\static'):
...
#         fig.write_image(config.root_dir + config.slash + f"plotting_output\\{save_folder}\\static\\" + title + '.png', scale=1, width=width, height=height)
#     else:
