...
# gompertz_function_diagnostics_dataframe = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\road_model\\{}'.format(gompertz_function_diagnostics_dataframe_file_name))
...
# macro1.to_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\regression_based_growth_estimates.csv', index=False)
regression_based_growth_estimates = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\regression_based_growth_estimates.csv')
#drop unit
...
# Save fig
if save_fig:
    fig.write_image(config.root_dir + config.slash + 'plotting_output\\diagnostics\\png\\{}.png'.format(title))
...
plt.title(title)
#save
plt.savefig(config.root_dir + config.slash + 'plotting_output\\diagnostics\\png\\{}.png'.format(title))
...
#     #save the plot
#     fig.write_html(config.root_dir + config.slash + f"plotting_output\\diagnostics\\html\\{title}.html", auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
# ################################
