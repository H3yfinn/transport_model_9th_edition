...
model_output_8th = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\activity_efficiency_energy_road_stocks.csv')
model_8th_by_fuel = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\cleaned_input_data\\energy_with_fuel.csv')
...
for vehicle_type in ['2w', 'ldv']:
    ...
    plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\8th_edition\\' + title + '.html', auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
# fig.write_image(config.root_dir + config.slash + "\\plotting_output\\8th_edition\\static\\" + title + '.png', scale=1, width=2000, height=1500)
...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\8th_edition\\' + title + '.html', auto_open=True)
# fig.write_image(config.root_dir + config.slash + "\\plotting_output\\8th_edition\\static\\" + title + '.png', scale=1, width=2000, height=1500)
...
region_mapping = pd.read_csv(config.root_dir + config.slash + 'config\\utilities\\region_economy_mapping.csv')
...
emissions_factors = pd.read_csv(config.root_dir + config.slash + 'config\\utilities\\emission_factors_for_8th_edition_transport.csv')
...
#         plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\8th_edition\\' + title + '_' + vehicle + '_' + transport_type + '.html',auto_open=AUTO_OPEN_PLOTLY_GRAPHS)
#         fig.write_image(config.root_dir + config.slash + "\\plotting_output\\8th_edition\\static\\" + title + '_' + vehicle + '_' + transport_type + '.png', scale=1, width=2000, height=1500)
