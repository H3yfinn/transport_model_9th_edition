...
behavioural_policy_df_1.to_csv(config.root_dir + config.slash + 'other_code\\other_data\\archive\\behavioural_policy_df_1.csv')
behavioural_policy_df_2.to_csv(config.root_dir + config.slash + 'other_code\\other_data\\archive\\behavioural_policy_df_2.csv')
behavioural_policy_df_3.to_csv(config.root_dir + config.slash + 'other_code\\other_data\\archive\\behavioural_policy_df_3.csv')
behavioural_policy_df_4.to_csv(config.root_dir + config.slash + 'other_code\\other_data\\archive\\behavioural_policy_df_4.csv')
