...
vehicle_sales_share_normalised = pd.read_csv(config.root_dir + config.slash + 'input_data\\from_8th\\reformatted\\vehicle_sales_share_normalised.csv')
...
plotly.offline.plot(fig, filename=config.root_dir + config.slash + 'plotting_output\\archive\\' + title + '.html')
fig.write_image(config.root_dir + config.slash + "\\plotting_output\\static\\archive\\" + title + '.png', scale=1, width=2000, height=800)
