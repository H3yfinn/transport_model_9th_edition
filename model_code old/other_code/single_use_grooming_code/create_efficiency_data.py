...
transport_data_system_df_original = pd.read_csv(config.root_dir + config.slash + '{}\\output_data\\9th_dataset\\combined_dataset_{}.csv'.format(transport_data_system_folder,FILE_DATE_ID2))
...
if analyse:
    ...
    transport_data_system_df2 = pd.read_csv(config.root_dir + config.slash + '{}\\output_data\\9th_dataset\\combined_dataset_{}.csv'.format(transport_data_system_folder,FILE_DATE_ID2))
...
if analyse:
    ...
    plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_data_bar.html', auto_open=True)
...
if analyse:
    ...
    plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_data_l_per_100km_bar.html', auto_open=True)
...
if analyse:
    ...
    plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_data_l_per_100km_box_no_outliers.html', auto_open=True)
...
if analyse:
    ...
    plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_data_l_per_100km_bar_no_outliers.html', auto_open=True)
#%%
...
new_df.to_csv(config.root_dir + config.slash + 'input_data\\calculated\\new_vehicle_efficiency_other_estimates_2023Feb.csv',index=False)
...
if analyse:
    ...
    plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\new_vehicle_efficiency_data.html')
...
if analyse:
    ...
    for vehicle in efficiency_other['Vehicle Type'].unique():
        ...
        #show
        plot.show()
        plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_violins\\efficiency_other_{}.html'.format(vehicle))
    ...
    # plot.show()
    # plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_other.html')
...
if analyse:
    ...
    plot.show()
    plot.write_html(config.root_dir + config.slash + 'plotting_output\\testing\\efficiency_violins\\efficiency_other_all.html')
...
if calculate_again:
    ...
    #save it so that it can be concatenated to the transport_data_system_df_original
    finalised_new_vehicle_efficiency_ldv_ice.to_csv(config.root_dir + config.slash + 'input_data\\calculated\\iea_new_vehicle_efficiency_ldv_ice.csv',index=False)
...
#save it so that it can be concatenated to the transport_data_system_df_original
other_eff_data_new.to_csv(config.root_dir + config.slash + 'input_data\\calculated\\new_vehicle_efficiency_other_estimates.csv',index=False)
#%%
