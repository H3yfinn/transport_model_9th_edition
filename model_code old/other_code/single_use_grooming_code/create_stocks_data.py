...
transport_data_system_df_original = pd.read_csv(config.root_dir + config.slash + '{}\\output_data\\{}_interpolated_combined_data.csv'.format(transport_data_system_folder,FILE_DATE_ID2))

#laod estimated ldv data
# '\\input_data\\calculated\\ldv_data.csv'
ldv_data = pd.read_csv(config.root_dir + config.slash + 'input_data\\calculated\\ldv_data.csv')
...
ATO_ECONOMIES =['01_AUS', '02_BD', '05_PRC', '06_HKC', '07_INA', '08_JPN',
       '09_ROK', '10_MAS', '12_NZ', '13_PNG', '15_PHL', '16_RUS', '17_SGP',
       '18_CT', '19_THA', '21_VN']
