...
class Config:
    def __init__(self, root_dir):
        #depenmding on the os we want to use \\'s or /'s. this is because we need to use a mix of windows and linux paths and windows requires the long path prefix \\?\ to handle long paths. This is not needed for linux paths.
        if os.name == 'nt':
            self.slash = '\\'
        else:
            self.slash = '/'
