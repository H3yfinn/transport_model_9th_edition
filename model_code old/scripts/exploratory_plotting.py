...
# def compare_values_between_projections_using_two_files(config, projection_filename1, projection_filename2, measure, title, filter_dict, grouping, graph_type, save_folder):
...
def compare_values_between_projections_using_two_files(config, projection_filename1, projection_filename2, measure, title, filter_dict, grouping, graph_type, save_folder, emissions_factors=None, font_size=24):
    ...
    for name, fig in figs.items():
        fig.write_html(config.root_dir + config.slash +f'{save_folder}\\{title}_{name}.html')
...
df1_ref_cum, df2_ref_cum, difference_ref_cum, difference_percent_ref_cum = compare_values_between_projections_using_two_files(config,  config.root_dir + config.slash +'plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327.csv','plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327_HEV.csv', measure='cumulative_emissions', title='Canada cumulative emissions comparison (REF)', filter_dict=filter_dict, grouping=['Date', 'Fuel'], graph_type='timeseries_proportion', save_folder=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons', emissions_factors=emissions_factors,font_size=24)

emissions_factors = pd.read_csv(config.root_dir + config.slash + 'config\\9th_edition_emissions_factors.csv')
filter_dict = {'Scenario':['Target'], 'Economy':['03_CDA'], 'Medium':['road'],'Transport Type': ['passenger']}
df1_tgt_cum, df2_tgt_cum, difference_tgt_cum, difference_percent_tgt_cum = compare_values_between_projections_using_two_files(config,  config.root_dir + config.slash +'plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327.csv','plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327_HEV.csv', measure='cumulative_emissions', title='Canada cumulative emissions comparison (TGT)', filter_dict=filter_dict, grouping=['Date', 'Fuel'], graph_type='timeseries_proportion', save_folder=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons', emissions_factors=emissions_factors,font_size=24)

#%%
emissions_factors = pd.read_csv(config.root_dir + config.slash + 'config\\9th_edition_emissions_factors.csv')
filter_dict = {'Scenario':['Reference'], 'Economy':['03_CDA'], 'Transport Type': ['passenger'], 'Medium':['road']}
df1_ref_abs, df2_ref_abs, difference_ref_abs, difference_percent_ref_abs = compare_values_between_projections_using_two_files(config, config.root_dir + config.slash + 'plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327.csv','plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327_HEV.csv', measure='Emissions', title='Canada emissions comparison (REF)', filter_dict=filter_dict, grouping=['Date', 'Fuel'], graph_type='timeseries_proportion', save_folder=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons', emissions_factors=emissions_factors,font_size=24)

emissions_factors = pd.read_csv(config.root_dir + config.slash + 'config\\9th_edition_emissions_factors.csv')
filter_dict = {'Scenario':['Target'], 'Economy':['03_CDA'], 'Medium':['road'],'Transport Type': ['passenger']}
df1_tgt_abs, df2_tgt_abs, difference_tgt_abs, difference_percent_tgt_abs = compare_values_between_projections_using_two_files(config, config.root_dir + config.slash + 'plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327.csv','plotting_output\experimental\Nanjing_comparisons\03_CDA_model_output20240327_HEV.csv', measure='Emissions', title='Canada emissions comparison (TGT)', filter_dict=filter_dict, grouping=['Date', 'Fuel'], graph_type='timeseries_proportion', save_folder=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons', emissions_factors=emissions_factors,font_size=24)

#%%

def plot_comparison_ref_vs_tgt(config, difference_percent_ref_filename, difference_percent_tgt_filename, measure, title, save_folder, font_size=24):
    """
    ...
    # Save the figure
    fig.write_html(config.root_dir + config.slash +f'{save_folder}\\{title}_Percentage_Difference_Comparison.html')
...
plot_comparison_ref_vs_tgt(
    difference_percent_ref_filename=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons\\Canada cumulative emissions comparison (REF)_difference_percent_difference_percent.csv',
    difference_percent_tgt_filename=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons\\Canada cumulative emissions comparison (TGT)_difference_percent_difference_percent.csv',
    measure='cumulative_emissions_percent',
    title='Canada Cumulative Emissions Reductions Comparison',
    save_folder=config.root_dir + config.slash +'plotting_output\\experimental\\Nanjing_comparisons',
    font_size=24
)

plot_comparison_ref_vs_tgt(
    difference_percent_ref_filename=config.root_dir + config.slash + 'plotting_output\\experimental\\Nanjing_comparisons\\Canada emissions comparison (REF)_difference_percent_difference_percent.csv',
    difference_percent_tgt_filename=config.root_dir + config.slash + 'plotting_output\\experimental\\Nanjing_comparisons\\Canada emissions comparison (TGT)_difference_percent_difference_percent.csv',
