...
def concatenate_output_data(config):
    ...
    for e in config.ECONOMY_LIST:
        if not os.path.exists(config.root_dir + config.slash + 'output_data\\model_output_detailed\\{}_{}'.format(e, config.model_output_file_name)):
            ...
            file_date_id_for_economy = utility_functions.get_latest_date_for_data_file(config.root_dir + config.slash + 'output_data\\model_output_detailed\\', f"{e}_{config.model_output_file_name.replace(config.FILE_DATE_ID, '')}".strip('.csv'), '.csv')
            if file_date_id_for_economy is None:
                not_all_economies = True
                break
            model_output_detailed_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\{}_{}'.format(e, config.model_output_file_name.replace(config.FILE_DATE_ID, file_date_id_for_economy)))
            model_output_non_detailed_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output\\{}_{}'.format(e, config.model_output_file_name.replace(config.FILE_DATE_ID, file_date_id_for_economy)))
            model_output_all_with_fuels_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\{}_{}'.format(e, config.model_output_file_name.replace(config.FILE_DATE_ID, file_date_id_for_economy)))
            
            #now for NON_ROAD_DETAILED_ files:
            model_output_detailed_non_road_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\{}_NON_ROAD_DETAILED_{}'.format(e, config.model_output_file_name.replace(config.FILE_DATE_ID, file_date_id_for_economy)))
            model_output_non_detailed_non_road_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output\\{}_NON_ROAD_DETAILED_{}'.format(e, config.model_output_file_name.replace(config.FILE_DATE_ID, file_date_id_for_economy)))
            model_output_all_with_fuels_non_road_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\{}_NON_ROAD_DETAILED_{}'.format(e, config.model_output_file_name.replace(config.FILE_DATE_ID, file_date_id_for_economy)))
            ...
            model_output_detailed_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\{}_{}'.format(e, config.model_output_file_name))
            
            model_output_non_detailed_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output\\{}_{}'.format(e, config.model_output_file_name))
            model_output_all_with_fuels_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\{}_{}'.format(e, config.model_output_file_name))
            
            #now for NON_ROAD_DETAILED_ files:
            model_output_detailed_non_road_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\{}_NON_ROAD_DETAILED_{}'.format(e, config.model_output_file_name))
            model_output_non_detailed_non_road_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output\\{}_NON_ROAD_DETAILED_{}'.format(e, config.model_output_file_name))
            model_output_all_with_fuels_non_road_economy = pd.read_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\{}_NON_ROAD_DETAILED_{}'.format(e, config.model_output_file_name))
    ...
    if not_all_economies:
        ...
        return False
    #save the final df: 
    model_output_detailed.to_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\all_economies_{}_{}'.format(config.FILE_DATE_ID, config.model_output_file_name), index=False)
    model_output_non_detailed.to_csv(config.root_dir + config.slash + 'output_data\\model_output\\all_economies_{}_{}'.format(config.FILE_DATE_ID, config.model_output_file_name), index=False)
    model_output_all_with_fuels.to_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\all_economies_{}_{}'.format(config.FILE_DATE_ID, config.model_output_file_name), index=False)
    
    #save the final df: 
    model_output_detailed_non_road.to_csv(config.root_dir + config.slash + 'output_data\\model_output_detailed\\all_economies_NON_ROAD_DETAILED_{}_{}'.format(config.FILE_DATE_ID, config.model_output_file_name), index=False)
    model_output_non_detailed_non_road.to_csv(config.root_dir + config.slash + 'output_data\\model_output\\all_economies_NON_ROAD_DETAILED_{}_{}'.format(config.FILE_DATE_ID, config.model_output_file_name), index=False)
    model_output_all_with_fuels_non_road.to_csv(config.root_dir + config.slash + 'output_data\\model_output_with_fuels\\all_economies_NON_ROAD_DETAILED_{}_{}'.format(config.FILE_DATE_ID, config.model_output_file_name), index=False)
...
def create_output_for_cost_modelling(config, model_output_detailed, ECONOMY_ID):
    ...
    #save
    model_output_detailed.to_csv(config.root_dir + config.slash + f'output_data\\for_other_modellers\\cost_estimation\\{config.FILE_DATE_ID}_{ECONOMY_ID}_cost_inputs.csv', index=False)
    return
...
def create_output_for_cost_modelling_from_old_data(config, model_output_detailed, ECONOMY_ID):
    ...
    stocks_9th.to_csv(config.root_dir + config.slash + f'output_data\\for_other_modellers\\cost_estimation\\{config.FILE_DATE_ID}_{ECONOMY_ID}_cost_inputs_BASED_ON_OLD_DATA.csv', index=False)
...
# model_output_detailed = pd.read_csv(config.root_dir + config.slash + '19_THA_model_output20230902.csv')
# ECONOMY_ID = '19_THA'
