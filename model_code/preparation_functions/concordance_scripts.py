    ...
    if USE_LATEST_CONCORDANCES:
        ...
        if file_date_id == config.FILE_DATE_ID:
            ...
            try:
                ...
                if os.path.join(config.root_dir, 'intermediate_data', 'computer_generated_concordances', config.model_concordances_file_name_fuels.replace(file_date_id, config.FILE_DATE_ID)) != os.path.join(config.root_dir, 'intermediate_data', 'computer_generated_concordances', config.model_concordances_file_name_fuels):
