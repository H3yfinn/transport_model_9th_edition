...
def incorporate_logisitc_fitting_functions_new_growth_rates(growth_forecasts, activity_growth_estimates):
    ...
    if CLEAN_UP_GROWTH:
        new_growth_forecasts = logistic_fitting_functions_new.average_out_growth_rate_using_cagr(new_growth_forecasts, economies_to_avg_growth_over_all_years_in_freight_for = ['19_THA'])
