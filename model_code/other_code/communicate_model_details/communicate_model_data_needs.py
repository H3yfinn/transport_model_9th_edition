...
# # all_df = pd.read_csv(config.root_dir + '\\' + 'intermediate_data\\computer_generated_concordances\\{}'.format(model_concordances_all_file_name))

# # general_df = pd.read_csv(config.root_dir + '\\' + 'intermediate_data\\computer_generated_concordances\\{}'.format(model_concordances_file_name))

# user_input_concordances = pd.read_csv(config.root_dir + '\\' + 'intermediate_data\\computer_generated_concordances\\{}'.format(model_concordances_user_input_and_growth_rates_file_name))
# BASE_YEAR_measure_concordances = pd.read_csv(config.root_dir + '\\' + 'intermediate_data\\computer_generated_concordances\\{}'.format(model_concordances_BASE_YEAR_measures_file_name))
# demand_side_fuel_mixing_concordances = pd.read_csv(config.root_dir + '\\' + 'intermediate_data\\computer_generated_concordances\\{}'.format(model_concordances_demand_side_fuel_mixing_file_name))
# supply_side_fuel_mixing_concordances = pd.read_csv(config.root_dir + '\\' + 'intermediate_data\\computer_generated_concordances\\{}'.format(model_concordances_supply_side_fuel_mixing_file_name))
