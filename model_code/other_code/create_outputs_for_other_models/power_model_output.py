...
model_output_electricity.to_csv(config.root_dir + '\\' + 'output_data\\for_other_modellers\\LONG_ELEC_PJ_{}'.format(config.model_output_file_name), index=False)
model_output_electricity_wide.to_csv(config.root_dir + '\\' + 'output_data\\for_other_modellers\\WIDE_ELEC_PJ_{}'.format(config.model_output_file_name))
...
#save in wide and long format
model_output_phev_ev_stocks.to_csv(config.root_dir + '\\' + 'output_data\\for_other_modellers\\LONG_PHEV_EV_STOCKS_{}'.format(config.model_output_file_name), index=False)
model_output_phev_ev_stocks_wide.to_csv(config.root_dir + '\\' + 'output_data\\for_other_modellers\\WIDE_PHEV_EV_STOCKS_{}'.format(config.model_output_file_name))
