...
def save_economy_projections_and_all_inputs(ECONOMY_ID,  ZIP_UP_ARCHIVE_FOLDER=True, ARCHIVED_FILE_DATE_ID=None,transport_data_system_FILE_DATE_ID_2=None):
    ...
    if transport_data_system_FILE_DATE_ID_2 is None:
        ...
        if not os.path.exists(root_dir + '/' + f'intermediate_data/input_data_optimisations/optimised_data_{ECONOMY_ID}_{ARCHIVED_FILE_DATE_ID}_{transport_data_system_FILE_DATE_ID_2}.pkl'):
            ARCHIVED_FILE_DATE_ID_2 = other_utility_functions.get_latest_date_for_data_file(data_folder_path=root_dir + '/' +'intermediate_data/input_data_optimisations', file_name_start=f'optimised_data_{ECONOMY_ID}_', file_name_end=f'_{transport_data_system_FILE_DATE_ID_2}.pkl', EXCLUDE_DATE_STR_START=True)
    ...
    date_id = other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + 'input_data/9th_model_inputs', 'model_df_wide_')
    #create folder structure
    ...
    macro_date_id = other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + 'input_data/macro', 'APEC_GDP_data_')
    ...
    optimisation_data_date_id =other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + 'intermediate_data/input_data_optimisations', f'optimised_data_{ECONOMY_ID}_', f'_{transport_data_system_FILE_DATE_ID_2}.pkl', EXCLUDE_DATE_STR_START=True)
    ...
    date_id = other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + 'output_data/for_other_modellers/output_for_outlook_data_system', '{}_international_bunker_energy_use_'.format(ECONOMY_ID))
