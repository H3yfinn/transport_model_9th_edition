...
date_id = transport_model_9th_edition.code.other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + 'input_data/macro/', 'APEC_GDP_data_')
...
date_id = transport_model_9th_edition.code.other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + '../transport_data_system/intermediate_data/EGEDA/', 'EGEDA_transport_output')
...
def choose_and_filter_for_model_by_region(chosen_model_by_region_dict, chosen_file_date_id=None,region_column = 'Region_growth_regression2'):
    ...
    if chosen_file_date_id is not None:
        ...
        date_id = transport_model_9th_edition.code.other_utility_functions.get_latest_date_for_data_file(root_dir + '/' + 'intermediate_data/growth_analysis/','growth_coefficients_by_region')
