...
def create_all_concordances():
    ...
    # if not os.path.exists('config/concordances_and_config_data/computer_generated_concordances'):
        # os.makedirs('config/concordances_and_config_data/computer_generated_concordances')
    model_concordances.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_file_name), index=False)
    ...
    #save
    model_concordances_fuels.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_file_name_fuels), index=False)
    model_concordances_fuels_NO_BIOFUELS.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_file_name_fuels_NO_BIOFUELS), index=False)
    ...
    #now save
    model_concordances_BASE_YEAR_measures.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_base_year_measures_file_name), index=False)
    ...
    model_concordances_user_input_and_growth_rates.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_user_input_and_growth_rates_file_name), index=False)
...
def create_fuel_mixing_concordances(model_concordances_fuels):
    ...
    #save
    demand.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_demand_side_fuel_mixing_file_name), index=False)
    supply.to_csv('intermediate_data/computer_generated_concordances/{}'.format(config.model_concordances_supply_side_fuel_mixing_file_name), index=False)
