...
#%%
#laod data from 
# road_model_input = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\road_model_input_wide.csv')

# growth_forecasts = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\growth_forecasts.csv')

# non_road_model_input = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\non_road_model_input_wide.csv')

road_model_input_wide = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\road_model_input_wide.csv')
growth_forecasts = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\growth_forecasts.csv')
non_road_model_input_wide = pd.read_csv(config.root_dir + config.slash + 'intermediate_data\\model_inputs\\non_road_model_input_wide.csv')
