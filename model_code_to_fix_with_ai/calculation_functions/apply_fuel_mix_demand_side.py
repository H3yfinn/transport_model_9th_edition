...
def apply_fuel_mix_demand_side(config, model_output_all, ECONOMY_ID, demand_side_fuel_mixing=None, supply_side_fuel_mixing=None):
    ...
    # #save data
    # new_df_with_fuels.to_csv(config.root_dir + config.slash + 'intermediate_data\\model_output_with_fuels\\1_demand_side\\{}_{}'.format(ECONOMY_ID, config.model_output_file_name), index=False)
