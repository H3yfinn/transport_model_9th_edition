...
def run_road_model(config, ECONOMY_ID):
    ...
    growth_forecasts.to_pickle(config.root_dir + config.slash + f'intermediate_data\\road_model\\{ECONOMY_ID}_final_road_growth_forecasts.pkl')#save them sincewe will use them for non road
