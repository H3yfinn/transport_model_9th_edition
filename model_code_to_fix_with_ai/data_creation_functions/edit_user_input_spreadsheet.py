...
if do_this:
    ...
    user_input_file = pd.ExcelFile(config.root_dir + config.slash + 'input_data\\user_input_spreadsheet.xlsx', engine='openpyxl')
    for sheet in user_input_file.sheet_names:
        ...
        if sheet == user_input_file.sheet_names[0]:
            user_input = pd.read_excel(config.root_dir + config.slash + 'input_data\\user_input_spreadsheet.xlsx', sheet_name=sheet)
        else:
            user_input = pd.concat([user_input, pd.read_excel(config.root_dir + config.slash + 'input_data\\user_input_spreadsheet.xlsx', sheet_name=sheet)])
...
#####
    ...
    config.measure_to_unit_concordance = pd.read_csv(config.root_dir + config.slash + 'config\\concordances_and_config_data\\config.measure_to_unit_concordance.csv')
    ...
    transport_categories = pd.read_csv(config.root_dir + config.slash + 'config\\concordances_and_config_data\\manually_defined_transport_categories.csv')
...
# activity_efficiency_improvement = pd.read_csv(config.root_dir + config.slash + 'input_data\\user_input_spreadsheets\\activity_efficiency_improvement.csv')
# activity_efficiency_improvement = activity_efficiency_improvement.drop_duplicates()
# activity_efficiency_improvement.to_csv(config.root_dir + config.slash + 'input_data\\user_input_spreadsheets\\activity_efficiency_improvement.csv', index=False)
# %%
